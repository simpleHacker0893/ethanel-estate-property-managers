...
We are starting **Sprint 010 — Resident and landlord experience**. Services touched: `web`, `money-svc`.
...
6. `.docs/sprints/010-resident-and-landlord/requirements.md`
7. `.docs/sprints/010-resident-and-landlord/blueprint.md`
8. `.docs/sprints/010-resident-and-landlord/acceptance.md`

Then, before writing code:

```bash
graphify query "what already exists for resident and landlord experience?"
```
...
1. A partner's accountant runs a full month-end close on staging against their own portfolio data and signs off on the numbers.
2. A resident pays from the PWA and sees the receipt without refreshing.
3. A landlord's statement figures match the trial balance exactly.

These are restated in `.docs/sprints/010-resident-and-landlord/acceptance.md` with an evidence
...
Review the work against `.docs/sprints/010-resident-and-landlord/acceptance.md` and report:
