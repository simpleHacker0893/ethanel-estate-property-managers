...
|---|---|---|---|---|
| 1 | A partner's accountant runs a full month-end close on staging against their own portfolio data and signs off on the numbers. | _fill in the week before_ | | ☐ |
| 2 | A resident pays from the PWA and sees the receipt without refreshing. | _fill in the week before_ | | ☐ |
| 3 | A landlord's statement figures match the trial balance exactly. | _fill in the week before_ | | ☐ |
...
|---|---|---|---|
| **D-45** | Landlord and dashboard figures read live from the ledger with a 'last updated' stamp, never cached | | ☐ |
