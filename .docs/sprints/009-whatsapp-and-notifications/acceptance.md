...
|---|---|---|---|---|
| 1 | A resident pays and receives a WhatsApp receipt generated from the ledger entry, not from the callback. | _fill in the week before_ | | ☐ |
| 2 | Two staff cannot reply to the same conversation; the second sees it read-only. | _fill in the week before_ | | ☐ |
| 3 | A resident can turn off marketing notifications and cannot turn off a rent invoice. | _fill in the week before_ | | ☐ |
...
|---|---|---|---|
| **D-43** | One assignee per conversation, everyone else read-only, enforced by the data model | | ☐ |
| **D-48** | Financial notices are mandatory and cannot be turned off | | ☐ |
