...
|---|---|---|---|---|
| 1 | The burst test passes: 50/s for 10 minutes, zero loss. | _fill in the week before_ | | ☐ |
| 2 | The measured auto-match rate against the partners' real M-Pesa statements is published, whatever it is. | _fill in the week before_ | | ☐ |
| 3 | If the rate is under 95%, the causes are written into RISKS.md and the fix is scoped into Sprint 015. | _fill in the week before_ | | ☐ |
| 4 | A real shilling has moved through staging end to end. | _fill in the week before_ | | ☐ |
...
|---|---|---|---|
| **D-39** | 95% of payments matched with no human action (instrumented, not yet gated) | | ☐ |
| **D-41** | Webhook ingress: 50 callbacks per second for 10 minutes, zero loss | | ☐ |
