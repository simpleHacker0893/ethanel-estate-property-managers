...
|---|---|---|---|---|
| 1 | The first paying agency collects rent through Ethanel. | _fill in the week before_ | | ☐ |
| 2 | Ethanel's ledger and the partner's spreadsheet agree for a full rent cycle. | _fill in the week before_ | | ☐ |
| 3 | STATE.md records what actually shipped and what moved to R1.1. | _fill in the week before_ | | ☐ |
...
|---|---|---|---|
| **the pilot** | _not defined in the pack_ | | ☐ |
