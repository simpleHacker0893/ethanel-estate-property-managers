...
We are starting **Sprint 016 — Go-live**. Services touched: `all`, `production`.
...
6. `.docs/sprints/016-go-live/requirements.md`
7. `.docs/sprints/016-go-live/blueprint.md`
8. `.docs/sprints/016-go-live/acceptance.md`

Then, before writing code:

```bash
graphify query "what already exists for go-live?"
```
...
1. The first paying agency collects rent through Ethanel.
2. Ethanel's ledger and the partner's spreadsheet agree for a full rent cycle.
3. STATE.md records what actually shipped and what moved to R1.1.

These are restated in `.docs/sprints/016-go-live/acceptance.md` with an evidence
...
Review the work against `.docs/sprints/016-go-live/acceptance.md` and report:
