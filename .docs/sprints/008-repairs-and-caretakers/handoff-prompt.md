...
We are starting **Sprint 008 — Repairs, caretakers and running costs**. Services touched: `ops-svc`.
...
6. `.docs/sprints/008-repairs-and-caretakers/requirements.md`
7. `.docs/sprints/008-repairs-and-caretakers/blueprint.md`
8. `.docs/sprints/008-repairs-and-caretakers/acceptance.md`

Then, before writing code:

```bash
graphify query "what already exists for repairs, caretakers and running costs?"
```
...
1. Repair request -> work order -> cost -> landlord statement line completes end to end.
2. A real caretaker completes a task on their own low-end handset over mobile data, unaided and unobserved by you.
3. Every caretaker screen is under its KB budget.

These are restated in `.docs/sprints/008-repairs-and-caretakers/acceptance.md` with an evidence
...
Review the work against `.docs/sprints/008-repairs-and-caretakers/acceptance.md` and report:
