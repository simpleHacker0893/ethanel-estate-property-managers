...
We are starting **Sprint 011 — Marketplace, storefronts and viewings**. Services touched: `listing-svc`.
...
6. `.docs/sprints/011-marketplace-and-viewings/requirements.md`
7. `.docs/sprints/011-marketplace-and-viewings/blueprint.md`
8. `.docs/sprints/011-marketplace-and-viewings/acceptance.md`

Then, before writing code:

```bash
graphify query "what already exists for marketplace, storefronts and viewings?"
```
...
1. A storefront is publicly reachable, indexable, and renders the organization's branding.
2. A prospect searches, books a viewing, and attends it, with no one touching a phone book.

These are restated in `.docs/sprints/011-marketplace-and-viewings/acceptance.md` with an evidence
...
Review the work against `.docs/sprints/011-marketplace-and-viewings/acceptance.md` and report:
